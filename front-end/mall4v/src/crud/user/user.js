export const tableOption = {
  ...
  column: [{
    label: '注册手机号', prop: 'userMobile', sortable: true, search: true
  }, {
    label: '积分', prop: 'score', sortable: true
  }, {
    label: '用户昵称', prop: 'nickName', sortable: true, search: true
  }, {
    ...
    label: '注册时间', prop: 'userRegtime'
  }, {
    label: '最后使用小程序时间', prop: 'userLasttime'
  }, {
    label: '用户ID', prop: 'openId', display: false
  }]
}
